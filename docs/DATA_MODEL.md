...
edges solely for the existing task/event reducer allowlist with immutable claim
evidence. Its task-context and non-task canonical-event-context subsets may be
